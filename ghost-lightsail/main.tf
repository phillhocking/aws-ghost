...
resource "aws_route53_record" "red_no_www" {
  zone_id = data.aws_route53_zone.lightsail_dev_zone.zone_id  ## Delete prepending "data." if you are creating a new hosted zone
  name    = data.aws_route53_zone.lightsail_dev_zone.name     ## Delete prepending "data." if you are creating a new hosted zone
  type    = "A"
  ttl     = "300"
